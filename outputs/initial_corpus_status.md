...
- `outputs/reference_public_review_reports_2026-05-24.zip`
...
2026-05-19に、7項の臨床試験データ整理用プロンプト `prompt_pack/section7_clinical_data_prompt.md` と、zipの使い方を説明する `outputs/internal_copilot_pack_README.md` を追加した。

2026-05-24に、メール受信サイズ制限を避けるため、内部Copilot用のプロンプト類と公表審査報告書PDF本体を別zipに分割した。

次は、内部Copilotに `section7_clinical_data_prompt.md` を使わせ、必要な場合のみ別zipの公表PDFを参照させて、申請資料から7項本体の試験データ整理を作成する。
