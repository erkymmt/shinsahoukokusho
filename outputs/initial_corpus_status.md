...
- `raw_public_reports/` 配下の公表審査報告書PDF本体
...
2026-05-19に、7項の臨床試験データ整理用プロンプト `prompt_pack/section7_clinical_data_prompt.md` と、zipの使い方を説明する `outputs/internal_copilot_pack_README.md` を追加し、公表審査報告書PDF本体も内部投入用パックに含める対象とした。

次は、内部Copilotに `section7_clinical_data_prompt.md` と必要な公表PDFを参照させ、申請資料から7項本体の試験データ整理を作成する。
