...
2026-05-19に、7項の臨床試験データ整理用プロンプト `prompt_pack/section7_clinical_data_prompt.md` と、zipの使い方を説明する `outputs/internal_copilot_pack_README.md` を追加し、内部投入用パックに含める対象とした。
